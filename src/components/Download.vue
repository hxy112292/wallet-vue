...
export default {
  ...
  data() {
    return {
      downloadData: {
        url: 'https://www.hd-wallet.com:7070/update/apk',
  ...
  methods: {
    getApkVersion () {
      this.$axios.get('https://www.hd-wallet.com:7070/update/version').then( res=> {
    ...
    downloadApk () {
      ...
      let url = "https://www.hd-wallet.com:7070/update/apk"
